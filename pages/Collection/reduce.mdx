...
var code =  `var collection = { 'a': 1, 'b': 2, 'c': 1 }
console.log( Object(collection) ) // { a: 1, b: 2, c: 1 }
console.log( Object.keys(collection) ) // [ 'a', 'b', 'c' ]
console.log( Object.keys(Object(collection)) )  // [ 'a', 'b', 'c' ]
`   
  return (
    <div>
      <Embed source={code} />
